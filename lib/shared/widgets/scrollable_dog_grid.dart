...
class ScrollableDogGrid extends StatelessWidget {
  ...
  /// An observable list of dogs.
  final RxList dogs;

  /// Constructs a new instance of the [ScrollableDogGrid] class with the specified parameters.
  ///
  /// The [onLikeTap], [onTileTab], and [dogs] parameters must not be null.
  ...
  /// Builds the `ScrollableDogGrid` widget.
  ///
                    ...
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: SizedBox.fromSize(
                          child: AspectRatio(
                            aspectRatio: 1 / 1,
                            child: Image.network(dogs[index].mainPictureURL,
                                fit: BoxFit.fill),
                          ),
                        ),
                      ),
