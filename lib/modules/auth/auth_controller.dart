...
class AuthController extends GetxController {
  ...
  Future<void> createAndUploadChat() async {
    ...
    List<Message> messages = [
      Message(text: "Hola, me intersaria adoptarlo", date: "2023-05-08 10:00:00", isUser: true),
      Message(text: "Que bien!", date: "2023-05-08 10:01:00", isUser: false),
      Message(text: "Cuando podrias venir?", date: "2023-05-08 10:02:00", isUser: false),
    ];

    // Create a chat
    Chat chat = Chat(
      chatID: '', // The chat ID will be automatically generated by Firebase
      shelterID: 'l0nKmZYIJpsFoBv3mJBq', // Fictional shelter ID
      userID: 'IOGHSiIPsUYIyPhkEctJwYPDusE3', // Fictional user ID
      dogID: '4YCwkHj8Bjxm2EJXFb1a', // Fictional dog ID
      lastMessageDate: "2023-05-08 10:05:00", // The date of the last message
      messages: messages,
    );
    ...
    print("Chat  with created succesfully");
  }
  ...
  Future<void> createAndUploadDog() async {
    ...
    final dog23 = Dog(
      ...
      breed: 'Dálmata',
      description:
          'Dálmata travieso y lleno de energía en busca de una familia activa.',
      ...
      isReserved: false,
      mainPictureURL:
          'https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog24-1.jpg?alt=media&token=b3c145c1-50f1-43d4-952f-b4cf627fa250&_gl=1*1ymwox7*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjc1NjAuMC4wLjA.',
      pictureURLs: [
        "https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog24-1.jpg?alt=media&token=b3c145c1-50f1-43d4-952f-b4cf627fa250&_gl=1*1ymwox7*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjc1NjAuMC4wLjA.",
    ...
    final dog24 = Dog(
      ...
      breed: 'Border Collie',
      description:
          'Border Collie inteligente y enérgico en busca de un dueño activo.',
      ...
      isReserved: false,
      mainPictureURL:
          'https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog25-1.jpg?alt=media&token=347915e1-c4e9-4611-9a58-b3f19f96287d&_gl=1*1xdug5m*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjc2MDMuMC4wLjA.',
      pictureURLs: [
        "https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog25-1.jpg?alt=media&token=347915e1-c4e9-4611-9a58-b3f19f96287d&_gl=1*1xdug5m*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjc2MDMuMC4wLjA.",
    ...
    final dog25 = Dog(
      ...
      breed: 'Border Collie',
      description:
          'Border Collie inteligente y cariñoso en busca de una familia activa.',
      friendly: ['Personas', 'Perros'],
      notFriendly: ['Gatos'],
      gender: 'Hembra',
    ...
    final dog28 = Dog(
      ...
      breed: 'Shiba Inu',
      description:
          'Shiba Inu tranquilo y afectuoso en busca de una familia cariñosa.',
      friendly: ['Personas', 'Perros'],
      notFriendly: ['Gatos'],
      gender: 'Macho',
    ...
    final dog29 = Dog(
      ...
      breed: 'Husky',
      description:
          'Husky activo y sociable en busca de una familia deportista.',
      friendly: ['Personas', 'Perros'],
      notFriendly: ['Gatos'],
      gender: 'Hembra',
      ...
      isReserved: false,
      mainPictureURL:
          'https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog30-1.jpg?alt=media&token=37cb5d96-5bb1-4ab5-82ec-f28147e85303&_gl=1*1upp33p*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjgwMjYuMC4wLjA.',
      pictureURLs: [
        "https://firebasestorage.googleapis.com/v0/b/hundopt-db.appspot.com/o/dog30-1.jpg?alt=media&token=37cb5d96-5bb1-4ab5-82ec-f28147e85303&_gl=1*1upp33p*_ga*MTc0OTUwMjE4Ny4xNjg1MjA5MjA1*_ga_CW55HF8NVT*MTY4NjA2MzM4NS4xNC4xLjE2ODYwNjgwMjYuMC4wLjA.",
